...
<div class="row">
	...
	<div id="trx-result"></div>
		<?php
			if(x_count("topup_details","tranx_type='manual' AND status='0' LIMIT 1") > 0){
				$count = 0;
				?>
				...
				<tbody>
				<?php
				foreach(x_select("0","topup_details","tranx_type='manual' AND status='0'","0","id desc") as $topup){
					$count++;
					$id = $topup["id"];
					...
					<tr>
						...
						<td><span class="badge">TA = <?php echo "NGN ".number_format($credit,0);?> </span><br/>
						<span class="badge">
